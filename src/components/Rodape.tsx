      ...
      <section className="flex p-24 gap-16 size-full">
        <div className="w-full h-48">
          ...
          <div className="flex-col text-xl mb-24 gap-5">
            ...
            <p className=" mb-6 text-[#848484]">Partnership</p>
            <p className=" mb-6 text-[#848484]">Bussiness</p>
          </div>
          <div className="flex-col text-xl ">
            <h3 className="font-semibold mb-8">Community</h3>
            <p className=" mb-6 text-[#848484]">Events</p>
            <p className=" mb-6 text-[#848484]">Blogs</p>
            <p className=" mb-6 text-[#848484]">Podcast</p>
            <p className=" mb-6 text-[#848484]">Invite a friend</p>
          </div>
          <div className="flex-col text-xl">
            <h3 className="font-semibold mb-8">About</h3>
            <p className=" mb-6 text-[#848484]">How it works</p>
